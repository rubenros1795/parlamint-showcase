# Script for subsetting "flat" txt files based on presence of covid-19 related terms.
...
covid_subset_path = base_path + "/data/covid-subsets"
...
def subset(lan):
    ...
    path = f"{base_path}/data/original/{lan}/{lan}-txt-preproc/*"
